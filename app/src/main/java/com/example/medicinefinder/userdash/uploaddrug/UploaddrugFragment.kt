package com.example.myapplication.userdash.uploaddrug
...
import com.example.medicinefinder.databinding.FragmentUploadDrugBinding
...
class UploaddrugFragment : Fragment() {
    ...
    private var _binding: FragmentUploadDrugBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUploadDrugBinding.inflate(inflater, container, false)
        val root: View = binding.root

//        val textView: TextView = binding.textGallery
//        uploaddrugViewModel.text.observe(viewLifecycleOwner, Observer {
//            textView.text = it
//        })
        return root
    }
